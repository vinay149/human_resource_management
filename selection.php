...
<H1> CONFIRM APPLICANT ID FOR SELECTION</H1>
<H4> Please write the applicant id to confirm </H4>
<form method="post" action="sel_confirm.php">
<input type= "text" placeholder="APPLICANT ID"  name="app_id" />&nbsp;
<input type="submit"  value="SELECTED" />
<br /><br /><br /><br />
</form>
<form method="post" action="reject1.php">
<input type= "text" placeholder="APPLICANT ID"  name="app_id" />&nbsp;
<input type="submit"  value="REJECT SELECTION" />
<br /><br /><br /><br />
</form>
<a href="interview1.php"><input type="button" value="BACK" /><br /></a>
